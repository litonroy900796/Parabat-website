        ...
        <div className="md:w-[40%] w-full 5/5 relative md:px-2">
          <div className="md:absolute md:left-[20%] flex py-20 md:py-0 items-center h-full w-full ">
            <div className=" pr-2 pl-1 md:pl-0 md:w-[80%] w-full">
              <h1 className="md:text-7xl text-6xl font-bold leading-tight">
                Future <br /> of furniture
              </h1>
              <p className="my-4">
                Frontend design involves creating the HTML, CSS, and
                presentational JavaScript,React code that
              </p>
                  ...
                  <div className="absolute top-96 left-40">
                    <div className="relative">
                      {BannerImg.one && (
                        <div>
                          <span
                            class="flex h-4 w-4 cursor-pointer"
                      ...
                      {BannerImgDes.one ? (
                        <>
                          <div className="absolute bottom-[150%] left-[50%] bg-white px-5 py-2 rounded-xl w-60 shadow">
                            <p className="text-gray-600">
                              <b>Hello Liton</b>
                            </p>
                            <p>
                              This is a{" "}
                              <a href="https://www.linkedin.com/in/liton-chandra-barman-67aa84241/">
                                me
                              </a>
                              .
                            </p>
